namespace RaceStrategyApp.Services.Models
{
    public class StintCalculatorInputs
    {
        ...
        public StintCalculatorInputs(int laptimeMinutes, int laptimeSeconds, int laptimeMiliseconds, double litersPerLap, int stintHours, int stintMinutes, bool hasFormationLap, int tankSize, int stintLimitInMinutes = int.MaxValue/60)
        {
            ...
            this.StintLimitInSeconds = stintLimitInMinutes*60;
        }
    }
}
